    ...
    render: function() {
        return (
            <div>
                ...
                <input onChange={this.textChanged} value={this.state.input} type="date" className="form-control" id="zip" placeholder="e.g. 01/23/2018"   />
                <hr />
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <p> Deliver date: {order.deliver} </p>
                            <p> Deliver time: {order.time} </p>
                        </div>
...
var OrderPage = React.createClass({
    ...
    changePageTo: function(order, pageName) {
        ...
        switch (pageName) {
            ...
            case "FOOD":
                this.setState({page: <FoodSelect food={this.props.food} order={order} to={this.changePageTo} step={1} />});
                break;
